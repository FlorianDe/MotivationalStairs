...
/**
 * This along with PongPanelGame implements the view of the simple Pong game.
 * @author bylander
 */
public class PongView extends JFrame {
    ...
    public PongView(PongModel model) {
        ...
        // so the PongPanelGame can listen to the keyboard
    ...
    /**
     * @return The size of the PongPanelGame.
     */
